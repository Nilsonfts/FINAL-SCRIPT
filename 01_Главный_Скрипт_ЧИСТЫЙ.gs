...
function runCompleteAnalysis() {
  ...
  try {
    ...
    runLeadsByChannels();         // 📊 ЛИДЫ ПО КАНАЛАМ  
    ...
    try {
      runMarketingChannelsAnalysis(); // 📈 МАРКЕТИНГ И КАНАЛЫ
      console.log('✅ Маркетинг и каналы - выполнено');
    } catch (error) {
      console.warn('⚠️ Маркетинг и каналы - пропущено:', error.message);
    }
    ...
    try {
      runCallTrackingAnalysis();      // 📞 КОЛЛ-ТРЕКИНГ
      console.log('✅ Колл-трекинг - выполнено');
    } catch (error) {
      console.warn('⚠️ Колл-трекинг - пропущено:', error.message);
    }
...
function runMergedAmoAnalysis() {
  ...
  try {
    ...
    // ШАГ 3: Запускаем анализ лидов по каналам
    console.log('🎯 ШАГ 3: Запуск анализа лидов по каналам...');
    try {
      runLeadsByChannels();
      console.log('✅ ШАГ 3: Анализ лидов по каналам выполнен');
    } catch (error) {
      console.error('⚠️ ШАГ 3: Ошибка анализа лидов:', error.message);
    }
